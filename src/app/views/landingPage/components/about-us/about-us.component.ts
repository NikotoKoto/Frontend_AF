...
import { ABOUT_US_DATA, AboutUsItem } from '../../../../shared/data/about-us-data';
  ...
  template: `
    <section class="pt-0 pb-20 bg-gradient-to-b from-gray-100 via-gray-100 to-white">
      <div class="max-w-6xl mx-auto px-6 text-center">
        <h2 class="pt-10 text-4xl md:text-6xl xl:text-8xl font-heading tracking-tight text-gray-900">
          Notre monde floral
        </h2>
