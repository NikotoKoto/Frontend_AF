...
export const SOCIAL_MEDIA_FOOTER_DATA: SocialMediaFooterItem[] = [
  {
    link: 'https://www.facebook.com/AudaceFlorale',
    svg: `<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
            <path d="M13 22v-8h3l1-4h-4V7.5c0-1.1.3-1.8 1.9-1.8H17V2.2C16.4 2.1 15.4 2 14.2 2 11.6 2 10 3.5 10 6.1V10H7v4h3v8h3z"/>
         </svg>`,
    
  },
  {
    link: 'https://www.instagram.com/audace.florale/',
    svg: `<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    link: 'https://www.pinterest.fr/audaceflorale/_created/',
    svg: `<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
